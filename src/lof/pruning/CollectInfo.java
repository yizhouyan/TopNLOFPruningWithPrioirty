...
import lof.pruning.CollectInfo.Counters;
...
//						+ CanPrunePoints.size());
				...
				mos.write(new LongWritable(1),
						new Text("LOF Information Of Partition " + "\t" + currentPid + "\t" + thresholdLof),
	...
	public void run(String[] args) throws Exception {
		...
		/** set job parameter */
		Job job = Job.getInstance(conf, "First MapReduce: Cell-Based KNN Searching");

		job.setJarByClass(CollectInfo.class);
	...
	public static void main(String[] args) {
		CollectInfo findKnnAndSupporting = new CollectInfo();
		try {
