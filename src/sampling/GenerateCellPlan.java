...
public class GenerateCellPlan {
	public static class GenerateCellPlanMapper extends Mapper<LongWritable, Text, IntWritable, Text> {
	...
	public static class GenerateCellPlanReducer extends Reducer<IntWritable, Text, NullWritable, Text> {
		/**
...
//					System.out.println("i = " + i);
	...
	public void run(String[] args) throws Exception {
		...
		/** set job parameter */
		Job job = Job.getInstance(conf, "Distributed Generate Cell Plan (Sampling part)");

		job.setJarByClass(GenerateCellPlan.class);
		job.setMapperClass(GenerateCellPlanMapper.class);
		job.setReducerClass(GenerateCellPlanReducer.class);
		job.setMapOutputKeyClass(IntWritable.class);
		job.setMapOutputValueClass(Text.class);
		job.setOutputKeyClass(NullWritable.class);
		job.setOutputValueClass(Text.class);
		job.setNumReduceTasks(conf.getInt(SQConfig.strNumOfReducers, 100));
	...
	public static void main(String[] args) throws Exception {
		GenerateCellPlan gcp = new GenerateCellPlan();
		gcp.run(args);
	}
}
